  ...
  <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <img src="../landing/images/logoRclLogoBorder.svg" height="300px"/>
        ...
        <div class="col s12 m4">
          <div class="card ">
            <div class="card-image waves-effect waves-block waves-light">
              <img class="activator" src="../utils/img_logo_coompanies/'.$key['LOGO_URL'].'" height="300px">
            </div>
            <div class="card-content">
            <div style=" height:30px; text-overflow: ellipsis; overflow: hidden; white-space: nowrap"><span class="card-title activator grey-text text-darken-4">'.$key['NAME_COMPANY'].'<i class="material-icons right">more_vert</i></span></div>
              <div style=" height:30px; text-overflow: ellipsis; overflow: hidden; white-space: nowrap"><span>Página Web: </span><a href="'.$key['WEB_URL'].'" target="_blank">'.$key['WEB_URL'].'</a></div>
            </div>
