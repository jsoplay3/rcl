...
//  Gestion de usuarios
    $('#generoSolicitado').chosen({width:'100%'});
    $('#tipoSangreSolicitado').chosen({width:'100%'});
    $('#paisNacimientoSolicitado').chosen({width:'100%'});
    $('#estadoNacimientoSolicitado').chosen({width:'100%'});
    $('#ciudadNacimientoSocilitado').chosen({width:'100%'});
    $('#paisResidenciaSolicitado').chosen({width:'100%'});
    $('#estadoResidenciaSolicitado').chosen({width:'100%'});
    $('#ciudadResidenciaSocilitado').chosen({width:'100%'});
//  Gestion de inscripciones
    $('#carreraSolicitada').chosen({width:'100%'});
    $('#usuarioSolicitado').chosen({width:'100%'});
    $('#epsSolicitada').chosen({width:'100%'});
    $('#tallaCamisaSolicitada').chosen({width:'100%'});
